...
public class notUsing_AddPersonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.not_using_activity_add_person);

        OpenCVLoader.initDebug();

        Intent intent = getIntent();
        ArrayList<Image> image_list = intent.getParcelableArrayListExtra(notUsing_AddPersonPreviewActivity.IMAGES);
